...
function Character_Bass()
{
   ...
   jsSetCharDesc("Centurion Bass, usually referred to by his superiors as \"that insubordinate shit\" and thus destined to remain a centurion forever, had crossed one line too many and was sent to Harran痴 Pass to guard goats and occasional travelers, as well as act as the first line of defense against the Ordu tribes and die with honor and dignity or lack thereof.");
}  
