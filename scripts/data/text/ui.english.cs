...
$playgui_item_tooltip_format =   "<font:Noto Serif CJK JP:25>" @
                                 "<spush><color:FFFFFF>効果<spop><br>" @ 
                                 "<font:Noto Serif CJK JP:25><spush><color:AB9661><effect><spop><br>" @
                                 "<font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル効果<spop><br>" @
                                 "<font:Noto Serif CJK JP:25><spush><color:AB9661><critical_effect><spop><br>";
//Fast
...
$attack_tooltip_critical_effect[4] = "- 2ターンの間ノックダウン、1タイル分投げ出される<br>- 知覚が1減少 <br>- 最小で1ポイントのダメージ<br>- クリティカルダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Arterial Strike
$attack_tooltip_effect[5] = "- 高ダメージ <br>- 命中率　 -25% <br>- アーマーダメージ率　-25%<br>- クリティカル率 　-25%";
$attack_tooltip_critical_effect[5] = " - ダメージ耐性貫通 <br>- クリティカルダメージ <br>- 出血：4ダメージ （3ターンの間）<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
//Aimed: Torso
$attack_tooltip_effect[6] = "- 通常ダメージ <br>- 命中率　 -10% <br>- 30%のダメージ耐性貫通 ";
$attack_tooltip_critical_effect[6] = " - 70%のダメージ耐性貫通 <br>- 鎧のダメージ耐性が2減少 <br>- クリティカルダメージ <br>- 体力が1減少<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
//Aimed: Legs
$attack_tooltip_effect[7] = "- 低ダメージ <br>- 命中率　 -10% <br>- アーマーダメージ率　-50% <br>- 回避にペナルティ<br>- 合計： 5% + （武器AP-3） x5% （3ターンの間）";
$attack_tooltip_critical_effect[7] = "- 回避に2倍のペナルティ<br>- 敏捷が1減少<br>- 2ターンの間無力化 （移動コスト2倍）<br>- 最小で1ポイントのダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Aimed: Arms
$attack_tooltip_effect[8] = "- 低ダメージ <br>- 命中率　 -10% <br>- アーマーダメージ率　-50% <br>- アタックペナルティ(THC)<br>- 合計： 5% + （武器AP-3） x5% （3ターンの間）";
$attack_tooltip_critical_effect[8] = "- アタックに2倍のペナルティ(THC)<br>- 筋力が1減少<br>- 武装解除（ハンドスロットから武器を取り除く）<br>- 最小で1ポイントのダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Aimed: Legs - Ranged
$attack_tooltip_effect[9] = "- 低ダメージ <br>- 命中率　 -10% <br>- アーマーダメージ率　-50% <br>- 回避にペナルティ<br>- 合計： 5% + （武器AP-3） x5% （3ターンの間）";
$attack_tooltip_critical_effect[9] = "- 回避に2倍のペナルティ<br>- 敏捷が1減少<br>- 2ターンの間無力化 （移動コスト2倍）<br>- 最小で1ポイントのダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
//Aimed: Arms - Ranged
$attack_tooltip_effect[10] = "- 低ダメージ <br>- 命中率　 -10% <br>- アーマーダメージ率　-50% <br>- アタックペナルティ(THC)<br>- 合計： 5% + （武器AP-3） x5% （3ターンの間）";
$attack_tooltip_critical_effect[10] = "- アタックに2倍のペナルティ(THC)<br>- 筋力が1減少<br>- 武装解除（ハンドスロットから武器を取り除く）<br>- 最小で1ポイントのダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
//Swing
$attack_tooltip_effect[11] = "- 通常ダメージ <br>- 命中率　 -10%<br>- アーマーダメージ率　-10%<br>- キャラクターの前方の3タイルに及ぶ";
$attack_tooltip_critical_effect[11] = " - クリティカルダメージ <br>- 1ターンの間ノックダウン、 2タイル分投げ出される<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Cleave
$attack_tooltip_effect[12] = "- 高ダメージ <br>- 命中率　 -20% <br>- クリティカル率 　+35% <br>- アーマーダメージ率　+25%";
$attack_tooltip_critical_effect[12] = " - ダメージ耐性貫通 <br>- クリティカルダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Double Tap
...
$attack_tooltip_critical_effect[15] = " - ダメージ耐性貫通 <br>- クリティカルダメージ <br>- 2ターンの間敵の動きを止める <br>- 体力に1ポイントのダメージ<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Whirlwind
$attack_tooltip_effect[16] = "- 低ダメージ <br>- 命中率　 -20%<br>- アーマーダメージ率　-20%<br>- クリティカル率 　-20%<br>- 周囲の8マス全ての敵に同時に攻撃可能";
$attack_tooltip_critical_effect[16] = " - クリティカルダメージ <br>- 1ターンの間ノックダウン、1タイル分投げ出される<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Multishot
...
$attack_tooltip_critical_effect[19] = "- 相手のTHC（命中率）と回避を20ポイント下げる（2ターンの間） <br>- 次のターンで6AP失う<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（投擲 -（相手の敏捷 - 7）） x10";
//Throw Acid
...
$attack_tooltip_critical_effect[21] = "- 相手を移動不能にする（2ターンの間）<br>- 次のターンで6AP失う<br>- 回避にペナルティ 100%（2ターンの間）<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（投擲 -（相手の敏捷 - 7）） x10";
//Throw Bolas: Head
$attack_tooltip_effect[22] = "- ダメージなし <br>- 相手を窒息させる（1ターンの間）<br>- 次のターンで8AP失う<br>- ブロックと回避にペナルティ 100%（2ターンの間）";
$attack_tooltip_critical_effect[22] = "- 相手を窒息させる（2ターンの間）<br>- 次のターンで8AP失う<br>- ブロックと回避にペナルティ 100% （3ターンの間）<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（投擲 -（相手の敏捷 - 7）） x10";
//Feint
$attack_tooltip_effect[23] = "- ダメージなし <br>- 敵と場所を入れ替える<br>- アーマーダメージ率　-100%<br>- 命中率は回避 x10";
$attack_tooltip_critical_effect[23] = "- 敵と場所を入れ替える、ノックダウン<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（（筋力-7） - （相手の体力-7）） x5";
//Shield Bash
$attack_tooltip_effect[24] = "- ダメージなし <br>- 敵を1タイル押し出す";
$attack_tooltip_critical_effect[24] = "- 1ターンの間ノックダウン、1タイル分投げ出される<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（（筋力-7） - （相手の体力-7）） x5";
//Throw Liquid Fire
...
$attack_tooltip_critical_effect[26] = "- 1ターンの間ノックダウン、2-3タイル分投げ出される<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>- 基礎ポイント: 25 + 爆心地ボーナス - （相手の体力-6） x25<br>- 爆心地ならクリティカル率 50%アップ。 爆心地から離れるとこの値は低くなる。";
//Whirlwind - Blades
$attack_tooltip_effect[27] = "- 低ダメージ <br>- 命中率　 -15%<br>- アーマーダメージ率　-25%<br>- クリティカル率 　-25%<br>- 周囲の8マス全ての敵に同時に攻撃可能";
$attack_tooltip_critical_effect[27] = " - クリティカルダメージ <br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
//Quick Jab
...
//$attack_tooltip_effect[30] = "- ダメージなし <br>- 敵と場所を入れ替える, knockdown<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + (（武器AP-3） x2 + (STR-6) - (Victim CON-6)) x5";
...
$attack_tooltip_critical_effect[44] = "- 2ターンの間ノックダウン、1タイル分投げ出される <br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Strong Hammer Knockdown
$attack_tooltip_effect[45] = "- 低ダメージ <br>- 1ターンの間ノックダウン、1タイル分投げ出される <br>- 命中率　 -10% <br>- クリティカル率 　+25%";
$attack_tooltip_critical_effect[45] = "- 2ターンの間ノックダウン、1タイル分投げ出される <br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Whirlwind - 1H
$attack_tooltip_effect[47] = "- 低ダメージ <br>- 命中率　 -20%<br>- アーマーダメージ率　-20%<br>- クリティカル率 　-20%<br>- キャラクターの周囲4マス全てに同時に攻撃可能";
$attack_tooltip_critical_effect[47] = " - クリティカルダメージ <br>- 1ターンの間ノックダウン、1タイル分投げ出される<br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （筋力-7） x10";
//Whirlwind - Blades 1H
$attack_tooltip_effect[48] = "- 低ダメージ <br>- 命中率　 -15%<br>- アーマーダメージ率　-25%<br>- クリティカル率 　-25%<br>- キャラクターの周囲4マス全てに同時に攻撃可能";
$attack_tooltip_critical_effect[48] = " - クリティカルダメージ <br><font:Noto Serif CJK JP Bold:25><spush><color:FFFFFF>クリティカル率の計算式<spop><br><font:Noto Serif CJK JP Bold:25><spush><color:AB9661>（クリティカル率-クリティカル抵抗） + （知覚-7） x10";
