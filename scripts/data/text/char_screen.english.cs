...
$char_scr_skill0_level2    = " <spush><color:cc4300>[見習い]<spop> 短剣を握っている間は強そうに見えるようになった。君はただ相手を睨み付けていればいい。"; 
$char_scr_skill0_level3    = " <spush><color:ffa800>[一人前]<spop> 君は短剣を乱暴に振り回すだけでは限界があることに気付いた。";
$char_scr_skill0_level4    = " <spush><color:ffa800>[一人前]<spop> 標的に攻撃を当てることを学んだ。ほとんどの場合で。相手が動かなければ。";
$char_scr_skill0_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、いつか良いナイフ使いになれるかもしれない。"; 
...
$char_scr_skill1_level3    = " <spush><color:ffa800>[一人前]<spop> 君は剣を乱暴に振り回すだけでは限界があることに気付いた。";
$char_scr_skill1_level4    = " <spush><color:ffa800>[一人前]<spop> 標的に攻撃を当てることを学んだ。ほとんどの場合で。相手が動かなければ。";
$char_scr_skill1_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、いつか良い剣士になれるかもしれない。";
...
$char_scr_skill2_level3    = " <spush><color:ffa800>[一人前]<spop> 君は斧を乱暴に振り回すだけでは限界があることに気付いた。";
...
$char_scr_skill3_level3    = " <spush><color:ffa800>[一人前]<spop> 君はハンマーを乱暴に振り回すだけでは限界があることに気付いた。";
...
$char_scr_skill4_level4    = " <spush><color:ffa800>[一人前]<spop> 君は、８フィートの棒で何かを打つのは、思ったより簡単ではないことに気付いた。";
$char_scr_skill4_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツを掴んだ。大事なのは、敵をこちらに近付けないことだ。";
...
$char_scr_skill5_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、いつか良い射手になれるかもしれない。";
...
$char_scr_skill5_level10   = " <spush><color:24ff00>[マスター]<spop> They call you The Eagle Eye.";
...
$char_scr_skill6_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、いつか良いクロスボウ使いになれるかもしれない。";
...
$char_scr_skill6_level10   = " <spush><color:24ff00>[マスター]<spop> They call you The Eagle Eye.";
...
$char_scr_skill7_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、いつか良い投げナイフ人になれるかもしれない。";
...
$char_scr_skill8_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、思ったよりも長生きできるかもしれない。";
...
$char_scr_skill9_level5    = " <spush><color:ffcc00>[上級者]<spop> 君はコツをつかんだ。この調子なら、思ったよりも長生きできるかもしれない。";
...
$char_scr_skill10_level4    = " <spush><color:ffa800>[一人前]<spop> 君は相手の柔らかい部分を刺すとより効果的であると学んだ。";
...
//skill: Sneak
$char_scr_skill11_level1    = " <spush><color:cc0000>[素人]<spop> If you can't see them, they can't see you.";
$char_scr_skill11_level2    = " <spush><color:cc4300>[見習い]<spop> Move while they're not looking. Genius!";
$char_scr_skill11_level3    = " <spush><color:ffa800>[一人前]<spop> You've discovered that making noise is a dead giveaway. Dead giveaway.";
$char_scr_skill11_level4    = " <spush><color:ffa800>[一人前]<spop> You can stay still and be silent.";
$char_scr_skill11_level5    = " <spush><color:ffcc00>[上級者]<spop> You're getting the hang of it. Keep it up and you might live a bit longer than you thought.";
$char_scr_skill11_level6    = " <spush><color:ffcc00>[上級者]<spop> Better than average. And still alive. Better drink to that because the 'still alive' part might change without notice.";
...
//skill: Impersonate
$char_scr_skill12_level1    = " <spush><color:cc0000>[素人]<spop> Disguise? That's what fools do during carnivals!";
$char_scr_skill12_level2    = " <spush><color:cc4300>[見習い]<spop> The neighbor's children really liked it when you pretended to be a bear.";
$char_scr_skill12_level3    = " <spush><color:ffa800>[一人前]<spop> A little acting can go a long way to convince people.";
$char_scr_skill12_level4    = " <spush><color:ffa800>[一人前]<spop> You've discovered that you have a talent for imitating accents and impersonating people.";
$char_scr_skill12_level5    = " <spush><color:ffcc00>[上級者]<spop> You've realized that the devil is in the details - nobody likes a two-bit character.";
$char_scr_skill12_level6    = " <spush><color:ffcc00>[上級者]<spop> It's more than disguise - it's a performance art.";
...
//skill: Stealing
$char_scr_skill13_level1    = " <spush><color:cc0000>[素人]<spop> Maybe they shouldn't be looking while you're at it.";
$char_scr_skill13_level2    = " <spush><color:cc4300>[見習い]<spop> Ah, yes, move your fingers quickly. Who would have guessed?";
$char_scr_skill13_level3    = " <spush><color:ffa800>[一人前]<spop> Your style of thievery involves a lot of running away from guards.";
$char_scr_skill13_level4    = " <spush><color:ffa800>[一人前]<spop> You've realized that stealing people's stuff is much easier when they are somehow distracted.";
$char_scr_skill13_level5    = " <spush><color:ffcc00>[上級者]<spop> You're getting the hang of it. Keep it up and you might actually become a good thief one day.";
$char_scr_skill13_level6    = " <spush><color:ffcc00>[上級者]<spop> Better than average. And still alive. Better drink to that because the 'still alive' part might change without notice.";
...
//skill: Lockpicking
$char_scr_skill14_level1    = " <spush><color:cc0000>[素人]<spop> You used a rusty nail to break into a barn once. True story.";
$char_scr_skill14_level2    = " <spush><color:cc4300>[見習い]<spop> The best way to defeat a lock is to look for a spare key under rocks nearby.";
$char_scr_skill14_level3    = " <spush><color:ffa800>[一人前]<spop> You can easily open simple locks and doors left unlocked.";
$char_scr_skill14_level4    = " <spush><color:ffa800>[一人前]<spop> As your understanding of locks grows, so do your skills.";
$char_scr_skill14_level5    = " <spush><color:ffcc00>[上級者]<spop> You're getting the hang of it. Keep it up and you might become a good locksmith one day.";
$char_scr_skill14_level6    = " <spush><color:ffcc00>[上級者]<spop> You know the most common locking mechanisms and their weaknesses.";
...
//skill: Traps
$char_scr_skill15_level1    = " <spush><color:cc0000>[素人]<spop> Your idea of a trap is a board with a nail in it.";
$char_scr_skill15_level2    = " <spush><color:cc4300>[見習い]<spop> You are good at finding traps. The hard way.";
$char_scr_skill15_level3    = " <spush><color:ffa800>[一人前]<spop> You've learned that there are different kinds of traps. You named your scars after them.";
$char_scr_skill15_level4    = " <spush><color:ffa800>[一人前]<spop> You can disarm 4 out of 10 traps. The other 6 traps will surely kill you, but you're a 'glass half full' kinda guy.";
$char_scr_skill15_level5    = " <spush><color:ffcc00>[上級者]<spop> You're getting the hang of it. Keep it up and you might live a bit longer than you thought.";
$char_scr_skill15_level6    = " <spush><color:ffcc00>[上級者]<spop> Better than average. And still alive. Better drink to that because the 'still alive' part might change without notice.";
...
//skill: Persuasion
$char_scr_skill16_level1    = " <spush><color:cc0000>[素人]<spop> You're able to communicate with other primates.";
$char_scr_skill16_level2    = " <spush><color:cc4300>[見習い]<spop> You've discovered that the primates respond better to well-chosen words.";
$char_scr_skill16_level3    = " <spush><color:ffa800>[一人前]<spop> You've learned to string words together for greater oratory effect.";
$char_scr_skill16_level4    = " <spush><color:ffa800>[一人前]<spop> You're learned how to convince those who want to believe you.";
$char_scr_skill16_level5    = " <spush><color:ffcc00>[上級者]<spop> You've realized that Old Man Aesop was right: persuasion IS more effective than brute force.";
$char_scr_skill16_level6    = " <spush><color:ffcc00>[上級者]<spop> You've finally figured out how to win friends and influence people.";
...
//skill: Etiquette
$char_scr_skill17_level1    = " <spush><color:cc0000>[素人]<spop> You can belch your own name, and regularly demonstrate this talent in company.";
$char_scr_skill17_level2    = " <spush><color:cc4300>[見習い]<spop> You cover your mouth when you sneeze. Most of the time.";
$char_scr_skill17_level3    = " <spush><color:ffa800>[一人前]<spop> Your habit of bathing more than once a month is considered rather decadent.";
$char_scr_skill17_level4    = " <spush><color:ffa800>[一人前]<spop> The brothel whores consider you to be quite fancy.";
$char_scr_skill17_level5    = " <spush><color:ffcc00>[上級者]<spop> You're no longer a complete embarrassment to your friends.";
$char_scr_skill17_level6    = " <spush><color:ffcc00>[上級者]<spop> You've almost figured out which fork you're supposed to start with.";
...
//skill: Streetwise
$char_scr_skill18_level1    = " <spush><color:cc0000>[素人]<spop> You have absolute faith in the goodness of your fellow man.";
$char_scr_skill18_level2    = " <spush><color:cc4300>[見習い]<spop> You're the proud owner of a new bridge.";
$char_scr_skill18_level3    = " <spush><color:ffa800>[一人前]<spop> You're sure they'll pay you back as soon as they're able to.";
$char_scr_skill18_level4    = " <spush><color:ffa800>[一人前]<spop> You're beginning to suspect that some folk are being less than honest with you.";
$char_scr_skill18_level5    = " <spush><color:ffcc00>[上級者]<spop> Fool me once, shame on you. Fool me twice...well, the point is, you can't fool me, right?";
$char_scr_skill18_level6    = " <spush><color:ffcc00>[上級者]<spop> It's not a lie if you believe it.";
...
//skill: Lore
$char_scr_skill19_level1    = " <spush><color:cc0000>[素人]<spop> You can write your own name.";
$char_scr_skill19_level2    = " <spush><color:cc4300>[見習い]<spop> You like looking through scrolls, especially the ones with drawings.";
$char_scr_skill19_level3    = " <spush><color:ffa800>[一人前]<spop> The key to being a loremaster is knowing that if it's old, it's probably valuable.";
$char_scr_skill19_level4    = " <spush><color:ffa800>[一人前]<spop> You've realized that knowledge is power. Your enthusiasm for learning has never been greater.";
$char_scr_skill19_level5    = " <spush><color:ffcc00>[上級者]<spop> You're considering growing a beard. For stroking thoughtfully.";
$char_scr_skill19_level6    = " <spush><color:ffcc00>[上級者]<spop> You've learned much about the past and what you've learned drives you to seek more.";
...
//skill: Crafting
$char_scr_skill20_level1    = " <spush><color:cc0000>[素人]<spop> A blacksmith could entrust you to operate the bellows.<br><br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Bronze working - Masterwork weapons and armors - Balanced weapons - Reinforced armors and shields - Sharpen Weapons.";
$char_scr_skill20_level2    = " <spush><color:cc4300>[見習い]<spop> Horseshoes! Bronze nails! Cheap!<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Bronze working - Masterwork weapons and armors - Balanced weapons - Reinforced armors and shields - Sharpen Weapons.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Masterwork Shields - Hardened edge - Serrated edge - Hardened armors and shields.";
$char_scr_skill20_level3    = " <spush><color:ffa800>[一人前]<spop> You can make a decent living fixing farmers' tools.<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Masterwork Shields - Hardened edge - Serrated edge - Hardened armors and shields.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Iron working - Lightened Shields - Two technique slots.<br><spush><color:ffffff>Next Level Improves:<spop><color:EBEB00> Masterwork weapons and armor - Balanced weapons - Reinforced armor and Shields - Sharpen Weapons.";
$char_scr_skill20_level4    = " <spush><color:ffa800>[一人前]<spop> You've unlocked the secrets of iron! Your enemies must be terrified.<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Iron working - Lightened Shields - Two technique slots.<br><spush><color:ffffff>Improves:<spop><color:47FF47> Masterwork weapons and armor - Balanced weapons - Reinforced armor and Shields - Sharpen Weapons.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Lightened Armors.<br><spush><color:ffffff>Next Level Improves:<spop><color:EBEB00> Masterwork Shields - Hardened edge - Serrated edge - Hardened armors and shields.";
...
//skill: Trading
$char_scr_skill21_level1    = " <spush><color:cc0000>[素人]<spop> You got a good deal on those magic beans. Really!<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 15% of value - Buys for 125% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 20% of value - Buys for 125% of value.";
$char_scr_skill21_level2    = " <spush><color:cc4300>[見習い]<spop> You're beginning to suspect that certain merchants may be exaggerating the value of their wares.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 20% of value - Buys for 125% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 25% of value - Buys for 120% of value.";
$char_scr_skill21_level3    = " <spush><color:ffa800>[一人前]<spop> If it sounds too good to be true, it probably is.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 25% of value - Buys for 120% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 30% of value - Buys for 120% of value.";
$char_scr_skill21_level4    = " <spush><color:ffa800>[一人前]<spop> Buy low, sell high, that's the trick.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 30% of value - Buys for 120% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 35% of value - Buys for 115% of value.";
$char_scr_skill21_level5    = " <spush><color:ffcc00>[上級者]<spop> You're a real merchant now. You've got the abacus and everything.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 35% of value - Buys for 115% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 45% of value - Buys for 115% of value.";
$char_scr_skill21_level6    = " <spush><color:ffcc00>[上級者]<spop> You've learned the trick of turning one gold piece into two. A subtle and powerful magic.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 45% of value - Buys for 115% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 55% of value - Buys for 110% of value.";
...
$char_scr_skill21_level8    = " <spush><color:aeff00>[名人]<spop> People check that their coin pouches are still attached to their belts when you smile.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 65% of value - Buys for 110% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 75% of value - Buys for 105% of value.";
$char_scr_skill21_level9    = " <spush><color:84ff00>[達人]<spop> They say that everything you touch turns to gold.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 75% of value - Buys for 105% of value.<br><spop><spush><color:ffffff>Next Level Abilities:<spop><spush><color:EBEB00> Sells for 90% of value - Buys for 100% of value.";
$char_scr_skill21_level10   = " <spush><color:24ff00>[マスター]<spop> Money is the lifeblood of the world. And you drink deeply.<br><br><spush><color:ffffff>Abilities:<spop><spush><color:47FF47> Sells for 90% of value - Buys for 100% of value.";

//skill: Alchemy
$char_scr_skill22_level1    = " <spush><color:cc0000>[素人]<spop> You can tell salt by the taste alone.<br><br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Healing salve - Berserk potion - Poison vial.";
$char_scr_skill22_level2    = " <spush><color:cc4300>[見習い]<spop> When the mixture starts smoking, that's bad. Lesson learned.<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Healing salve - Berserk potion - Poison vial.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Liquid fire - Neurostimulant - Antidote.";
$char_scr_skill22_level3    = " <spush><color:ffa800>[一人前]<spop> Your allies fear your concoctions almost as much as your enemies.<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Liquid fire - Acid Vial - Neurostimulant - Antidote.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Restorative Liniment - Black Powder Bomb - Extended Neurostimulant.<br><spush><color:ffffff>Next Level Improves:<spop><color:EBEB00> Healing salve - Berserk potion - Poison.";
$char_scr_skill22_level4    = " <spush><color:ffa800>[一人前]<spop> Should your tongue be that colour?<br><br><spush><color:ffffff>Unlocks:<spop><color:47FF47> Restorative Liniment - Black Powder Bomb - Extended Neurostimulant.<br><spush><color:ffffff>Improves:<spop><color:47FF47> Healing salve - Berserk potion - Poison.<br><spush><color:ffffff>Next Level Unlocks:<spop><color:EBEB00> Extended berserk potion - Berserk Potion Hemostasis.<br><spush><color:ffffff>Next Level Improves:<spop><color:EBEB00> Neurostimulant - Acid Vial - Liquid fire.";
