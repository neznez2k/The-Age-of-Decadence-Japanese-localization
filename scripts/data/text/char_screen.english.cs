...
$char_scr_stat_tip1 = "<spush><color:ffffff>敏捷<spop> - キャラクター作成時の戦闘スキルポイント量に影響し、戦闘中のアクションポイントと順番を決定する。ゲーム内の会話とインタラトのチェックに使用される。";
...
$char_scr_stat_tip5 = "<spush><color:ffffff>魅力<spop> - キャラクター作成時の非戦闘スキルポイント量に影響し、反応や名声の補正を決定する。会話中で頻繁にチェックがあるステータス。";
...
$char_scr_rep_tip1 = "アウレリアン家の主な軍隊は戦争の間、遠く離れた植民地で、激しく血にまみれた戦場から離れ秩序を維持していた。世界が壊滅し社会が混沌とする中で、ガエリウス将軍は戦略的な要塞や町を強固に支配するために迅速に動いた。今日、アウレリアン家は、古い要塞の周りに建てられた町マードランの残骸の７０％を支配し、彼らに有利なパワーバランスを保つためにあらゆる努力をしている。こうしたアウレリアン家の現在の地位に対して、他の家は恨みを抱いている。";
...
$char_scr_rep_tip5 = "交易と商人のギルドは常に存在してきたが、剣の力によってもたらされた災厄の影で、金の力は国事に対してはるかに大きい影響力を持つようになった。主要な商人は今や全ての交易を総括し、管理している。キャラバン、関税、鉱山、そして市場はコンメルキウムの恩恵によって運営されている。前哨地や辺境の村では独立している商人は今も存在しているが、町での交易に危険や問題がないわけではない。";
$char_scr_rep_tip6 = "帝国の黎明期には、皇帝直属の衛兵がいた。彼らは皇帝を守るという本来の任務とは別に、潜入と暗殺のエキスパートとして訓練されていた。 多くの政治的、軍事的な敵対者たちが夜の狂喜の中の死や、説明のつかない不幸に遭遇し、帝国の長年にわたる安定を確保した。帝国の崩壊後、仕える主がいないため、衛兵たちは滅びた帝国の混沌へと散っていった。外の世界に出ると、世界が荒廃していても、彼らは自分たちの平和維持活動には大きな需要があると気付いた。暗殺教団が設立され、後にその一群は誉れ高き名を帯びることになる。「ステュクスの漕手」と。";
