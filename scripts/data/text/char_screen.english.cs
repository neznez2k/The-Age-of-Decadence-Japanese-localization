...
$char_scr_tip3 = "<spush><color:ffffff>槌<spop> -知られている中で最も古い武器の一つである槌は、単純な目的のために設計されている。敵を打ち、殺す。槌による強力な打撃は、屈強な男さえも圧倒させることで知られている。";
...
$char_scr_tip5 = "<spush><color:ffffff>弓<spop> - The only warrior who doesn\'t fear an archer is the one with a large shield to put between him and the deadly rain of arrows such foes can send their way. While those who favour the bow tend to be lightly armoured, few opponents ever get close enough to take advantage of that.";
$char_scr_tip6 = "<spush><color:ffffff>Crossbow<spop> - Like the bow, the crossbow is a deadly ranged weapon. And, while it lacks the speed, accuracy and range of the bow, the crossbow makes up for that in pure striking power. At close range, a crossbow bolt can hit hard enough to knock an opponent off his feet.";
$char_scr_tip7 = "<spush><color:ffffff>Throwing<spop> - Often overlooked because they lack power of their mechanically-assisted cousins, throwing weapons make up for their shorter range and power with their greater speed and finesse. A warrior skilled with throwing weapons can literally barrage an opponent with missiles.";
$char_scr_tip8 = "<spush><color:ffffff>Dodge<spop> - While warriors wear various types of armor to absorb their opponent\'s strikes, most agree that it is better not to be hit in the first place. Unfortunately, this can be a bit of a trade-off, as the heavier the armor, the harder it is to dodge blows while wearing it. It\'s also worth noting that successfully dodging an attack can leave an opponent off-balance and vulnerable to a counter attack. Each attack can be countered either by block or by dodge, never both at the same time. Therefore, most warriors choose to concentrate on one of these defensive skills.";
$char_scr_tip9 = "<spush><color:ffffff>Block<spop> - While the uninformed generally think of blocking as simply putting a shield between you and an attacker\'s weapon, true masters of the art know that blocking is all about deflecting a strike, angling your shield so that your foe\'s weapon slides away harmlessly. Each attack can be countered either by block or by dodge, never both at the same time. Therefore, most warriors choose to concentrate on one of these defensive skills.";
$char_scr_tip10 = "<spush><color:ffffff>Critical Strike<spop> - In the combat arts, as in most things, quality counts more than quantity. A single, well-aimed strike at a vital organ is worth a dozen superficial flesh-wounds. A wise fighter learns to maximize the effectiveness of each and every strike.";
$char_scr_tip11 = "<spush><color:ffffff>Sneak<spop> - The art of moving unseen and unnoticed. Sneaking is a very convenient, hassle-free way to visit places that aren\'t open to general public. Works most profitably with Lockpicking."; 
$char_scr_tip12 = "<spush><color:ffffff>Impersonate<spop> - The art of creating a different persona by modifying manners and appearance. It comes in handy when being yourself isn\'t enough, but may require an extensive wardrobe."; 
$char_scr_tip13 = "<spush><color:ffffff>Stealing<spop> - It\'s just like trading, but without the downside of having to give something to the other guy. Keep in mind that the laws of the Thieves\' Guild are less forgiving than the laws aimed to prevent one from stealing.";
$char_scr_tip14 = "<spush><color:ffffff>Lockpicking<spop> - The questionable art of opening locks without the right key in a fast and efficient manner. It\'s a very useful skill for wealth redistribution enthusiasts.";
$char_scr_tip15 = "<spush><color:ffffff>Traps<spop> - The theoretical knowledge and practical applications of traps. Be warned that the leading experts agree that the best traps aren\'t those that cause you minor inconvenience, but those that kill trespassers instantly, so if you\'re planning to trespass a lot, you may want to consider learning how to detect and disarm traps first."; 
$char_scr_tip16 = "<spush><color:ffffff>Persuasion<spop> - The smooth art of convincing people to act in your interests by reasoning and personal magnetism.";
$char_scr_tip17 = "<spush><color:ffffff>Etiquette<spop> - The understanding of proper behaviour protocols and how to apply them to your benefit.";
$char_scr_tip18 = "<spush><color:ffffff>Streetwise<spop> - A mix of different traits, ranging from shrewd awareness to inability to trust, that are most helpful when one deals with people a lot.";
$char_scr_tip19 = "<spush><color:ffffff>Lore<spop> - The knowledge and understanding of the events long gone, ancient languages, forgotten rituals, and mysterious objects. It\'s always a winner in a post-apocalyptic world.";
$char_scr_tip20 = "<spush><color:ffffff>Crafting<spop> - A skilled craftsman has the knowledge to create and improve their own equipment. While many good items can be found or bought, nothing can match the quality of a balanced blade forged from rare ores.";
$char_scr_tip21 = "<spush><color:ffffff>Trading<spop> - The theory and understanding of all commerce matters. More than an art of buying cheap, trading shows its acolytes the power of gold, uncovers hidden opportunities, and teaches that everything has a price.";
$char_scr_tip22 = "<spush><color:ffffff>Alchemy<spop> - The mystical art of transforming mundane organic and non-organic elements into magical items, like healing salves, potions that destroy metal, liquids that burn, and black powder fireballs. A must-have skill for mad scientists!";
