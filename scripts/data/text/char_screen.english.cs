...
$char_scr_skill20_level5    = " <spush><color:ffcc00>[上級者]<spop> コツをつかんできた。この調子なら、いつか鍛冶屋になれるかもしれない。<br><br><spush><color:ffffff>アンロック:<spop><color:47FF47> 輝く鎧。<br><spush><color:ffffff>向上:<spop><color:47FF47> 良質な盾 - 硬化した刃 - 鋸状の刃 - 硬化した鎧と盾。<br><spush><color:ffffff>次のレベルでアンロック:<spop><color:EBEB00> 鋼の加工。<br><spush><color:ffffff>次のレベルで向上:<spop><color:EBEB00> 良質な武器と鎧 - 武器の調整 - 鎧と盾の強化 - 武器の研磨。";
