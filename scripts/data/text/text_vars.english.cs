...
addConditionalVar("[melee success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>［近接　成功］<spop> ");
addConditionalVar("[ranged success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>［遠距離　成功］<spop> ");
...
addConditionalVar("[aurelian reputation success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>［アウレリアンの名声　成功］<spop> ");
addConditionalVar("[aurelian reputation failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>［アウレリアンの名声　失敗］<spop> ");
addConditionalVar("[crassus reputation success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>［クラッススの名声　成功］<spop> ");
addConditionalVar("[crassus reputation failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>［クラッススの名声　失敗］<spop> ");
addConditionalVar("[commercium reputation success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>［コンメルキウムの名声　成功］<spop> ");
addConditionalVar("[commercium reputation failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>［コンメルキウムの名声　失敗］<spop> ");
...
addConditionalVar("[melee]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>［近接］<spop> ");
addConditionalVar("[ranged]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>［遠距離］<spop> ");
addConditionalVar("[defense]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>［防御］<spop> ");
