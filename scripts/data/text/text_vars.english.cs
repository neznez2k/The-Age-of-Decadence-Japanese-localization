...
addConditionalVar("[crafting success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[crafting 成功]<spop> ");
addConditionalVar("[crafting failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[crafting 失敗]<spop> ");
addConditionalVar("[etiquette success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[etiquette 成功]<spop> ");
addConditionalVar("[trading success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[trading 成功]<spop> ");
addConditionalVar("[streetwise success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[streetwise 成功]<spop> ");
addConditionalVar("[persuasion success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[persuasion 成功]<spop> ");
addConditionalVar("[impersonate success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[impersonate 成功]<spop> ");
addConditionalVar("[alchemy success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[alchemy 成功]<spop> ");
addConditionalVar("[sneak success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[sneak 成功]<spop> ");
addConditionalVar("[sneak failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[sneak 失敗]<spop> ");
addConditionalVar("[traps success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[traps 成功]<spop> ");
addConditionalVar("[traps failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[traps 失敗]<spop> ");
addConditionalVar("[lockpick success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[lockpick 成功]<spop> ");
addConditionalVar("[lockpick failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[lockpick 失敗]<spop> ");
addConditionalVar("[steal success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[steal 成功]<spop> ");
...
addConditionalVar("[dodge success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[dodge 成功]<spop> ");
addConditionalVar("[dodge failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[dodge 失敗]<spop> ");
addConditionalVar("[block success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[block 成功]<spop> ");
addConditionalVar("[block failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[block 失敗]<spop> ");
addConditionalVar("[critical strike success]", "$pref::AoD::hideDlgTags", "", "<spush><color:45a053>[critical strike 成功]<spop> ");
addConditionalVar("[critical strike failure]", "$pref::AoD::hideDlgTags", "", "<spush><color:f12d45>[critical strike 失敗]<spop> ");
...
addConditionalVar("[traps]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[traps]<spop> ");
addConditionalVar("[sneak]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[sneak]<spop> ");
addConditionalVar("[lockpick]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[lockpick]<spop> ");
addConditionalVar("[steal]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[steal]<spop> ");
addConditionalVar("[persuasion]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[persuasion]<spop> ");
addConditionalVar("[streetwise]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[streetwise]<spop> ");
addConditionalVar("[impersonate]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[impersonate]<spop> ");
addConditionalVar("[etiquette]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[etiquette]<spop> ");
addConditionalVar("[alchemy]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[alchemy]<spop> ");
addConditionalVar("[crafting]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[crafting]<spop> ");
addConditionalVar("[lore]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[lore]<spop> ");
addConditionalVar("[trading]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[trading]<spop> ");

addConditionalVar("[bow]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[bow]<spop> ");
addConditionalVar("[crossbow]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[crossbow]<spop> ");
addConditionalVar("[throwing]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[throwing]<spop> ");
addConditionalVar("[dodge]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[dodge]<spop> ");
addConditionalVar("[block]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[block]<spop> ");
addConditionalVar("[critical strike]", "$pref::AoD::hideDlgTags", "", "<spush><color:f0f0f0>[critical strike]<spop> ");
